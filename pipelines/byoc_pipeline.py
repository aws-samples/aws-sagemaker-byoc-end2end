...
def create_pipeline(
    ...
    model_package_group_name = f"{model_package_group_name}"
    
    model_accuracy_threshold = kwargs["model_accuracy_threshold"]
    ...
    model_quality_baseline_step, statistics_report = model_quality_baseline(
        role=role,
        sagemaker_session=sagemaker_session,
    ...
    cond_lte = ConditionGreaterThan(
        left=JsonGet(
            step_name=model_quality_baseline_step.name,
            property_file=statistics_report,
...
def model_quality_baseline(
    ...
    **kwargs,
    ...
    statistics_report = PropertyFile(
        name=f"{prefix}StatisticsReport",
    ...
    step = ProcessingStep(
        ...
        property_files=[statistics_report],
    )
    return step, statistics_report